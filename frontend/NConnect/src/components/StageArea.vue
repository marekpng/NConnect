...
<!--                  <a href="#" @click="setActiveStage(index, $event)">-->
<!--                    <h4>{{ stage.name }}</h4>-->
<!--                    <h5>{{ stage.date }}</h5> &lt;!&ndash; Added stage.date here &ndash;&gt;-->
<!--                  </a>-->
<!--                </li>-->
<!--              </ul>-->
<!--            </div>-->
...
<!--      &lt;!&ndash; Add a new section to display selected session details &ndash;&gt;-->
<!--&lt;!&ndash;      <div v-if="selectedSession" class="selected-session-details">&ndash;&gt;-->
<!--&lt;!&ndash;        <h4>{{ selectedSession.title }}</h4>&ndash;&gt;-->
<!--&lt;!&ndash;        <p>{{ selectedSession.description }}</p>&ndash;&gt;-->
<!--&lt;!&ndash;        <p><strong>Presenter:</strong> {{ selectedSession.presenter }}</p>&ndash;&gt;-->
<!--&lt;!&ndash;        <p><strong>Organization:</strong> <a href="">{{ selectedSession.organization }}</a></p>&ndash;&gt;-->
<!--&lt;!&ndash;        <button @click="selectedSession = null">Close</button>&ndash;&gt;-->
<!--&lt;!&ndash;      </div>&ndash;&gt;-->
...
<!--        <button @click="showSignOutForm = true">Sign Out</button>  &lt;!&ndash; New Sign Out Button &ndash;&gt;-->
  ...
  <div class="schedule-area gray-bg">
    <div class="container">
      ...
      <div v-if="selectedSession" class="selected-session-details">
        ...
        <button @click="selectedSession = null">Close</button>
        <button @click="showRegistrationForm = true">Register</button>
        <button @click="showSignOutForm = true">Sign Out</button>
